                ...
                <>
                  ...
                  {activeTab === 'channels' && (
                    <div className="space-y-3 max-h-[360px] overflow-y-auto pr-0.5">
                      ...
                      {!hasSession && (
                        <div className="p-2.5 rounded-md bg-primary/5 border border-primary/20 text-[10px] text-muted-foreground">
                          <span className="text-primary font-semibold">Sign in with your wallet</span> to enable
                          Email/Telegram/Discord alerts and background monitoring. Browser notifications work without sign-in.
                        </div>
                      )}
                      ...
                      <div className="space-y-1.5">
                        ...
                        <ToggleRow
                          ...
                          disabled={!hasSession}
                          lockTitle="Sign in with your wallet to enable email alerts"
                        />
                        {channelPrefs.emailEnabled && (
                      ...
                      <div className="space-y-1.5">
                        ...
                        <ToggleRow
                          ...
                          disabled={!hasSession}
                          lockTitle="Sign in with your wallet to enable Telegram alerts"
                        />
                      ...
                      <div className="space-y-1.5">
                        ...
                        <ToggleRow
                          ...
                          disabled={!hasSession}
                          lockTitle="Sign in with your wallet to enable Discord alerts"
                        />
                        {channelPrefs.discordEnabled && (
