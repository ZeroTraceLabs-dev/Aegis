        ...
        <div className="hidden sm:flex max-w-6xl mx-auto px-4 h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-primary/40 text-primary text-[10px] font-medium hover:bg-primary/10 transition-colors"
            >
